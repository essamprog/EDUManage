        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Percent"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePictureKey = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Expertise = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Bio = table.Column<string>(type: "text", nullable: true),
                    Expertise = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "paymob"),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Pending"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    Level = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Beginner"),
                    ...
                    PromoVideoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PromoVideoKey = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    Language = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Arabic"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalWithdrawn = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
                    LifetimeEarnings = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_InstructorProfiles_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "InstructorProfiles",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    OrderIndex = table.Column<float>(type: "real", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    Progress = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountDetail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Pending"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Withdrawals_InstructorProfiles_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "InstructorProfiles",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoStatus = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Ready"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValue: "Sale"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_InstructorProfiles_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "InstructorProfiles",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatchTime = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QaQuestions_CourseLessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "CourseLessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QaQuestions_QaQuestions_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseLessons_DeletedAt_Status",
                table: "CourseLessons",
                columns: new[] { "DeletedAt", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_DeletedAt_Status",
                table: "Courses",
                columns: new[] { "DeletedAt", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_Status_CategoryId_IsBestseller",
                table: "Courses",
                columns: new[] { "Status", "CategoryId", "IsBestseller" });

            migrationBuilder.CreateIndex(
                name: "IX_CourseSections_CourseId_OrderIndex",
                table: "CourseSections",
                columns: new[] { "CourseId", "OrderIndex" });

            migrationBuilder.CreateIndex(
                name: "IX_CourseSections_DeletedAt",
                table: "CourseSections",
                column: "DeletedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QaQuestions_LessonId",
                table: "QaQuestions",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_QaQuestions_ParentId",
                table: "QaQuestions",
                column: "ParentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_InstructorId",
                table: "Transactions",
                column: "InstructorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_Status_Type_CreatedAt",
                table: "Transactions",
